...
public class Converter
{
    public static void main(String[] args) {
        try {
            ...
            BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(new File(args[0])), "UTF8"));
	 ...
	 if (pronunciation.indexOf("=") != -1) continue;
	 ...
	 detail = detail.replace("Tech", new String(new String("kĩ thuật").getBytes("ISO-8859-1"), "UTF-8"));
	 ...
	 detail = detail.replace("!", "+ ");
                ...
                bw.write(detail + "\n");
                cnt++;
                if (cnt % 1000 == 0) System.out.println("Loaded " + cnt + " words");
            }
